...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 fixed-start shadow box-shadow-sm pt-3" id="sidenav-main">
    <div class="sidenav-header h-10">
      ...
      <span class="navbar-brand m-0">
        ...
        <span class="ms-1 font-weight-bold">Than dep zai</span>
      </span>
    </div>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ps--active-y">
    ...
    <div class="container-fluid pl-4 pr-4 pb-4 pt-3">
      <div class="row" id="render-statistics">
      </div>
      <div class="row" id="render-statistics-select">
      </div>
      <div class="row" id="render-table">
      </div>
      <div class="row mt-4 chart-mode" id="chart-container">
